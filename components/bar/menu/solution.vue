    ...
    <div class="select-inner-container">
      <div class="horizontal-containers">
        ...
        <div class="introduce-box">
          <img src="https://file.kwunphi.com/kwunphi4/images/banner/2-machines-working-at-the-same-time.jpg?x-oss-process=image/resize,m_lfit,w_500,h_500">
        </div>
      </div>
<!--    关闭  -->
...
const menuDataList = ref([
  {
    ...
    subMenuList:[
      ...
      },
      {
        ...
        videoPoster:"",
        videoUrl:"",
        buttonTitle:"menu.indoorCases",
        buttonPath: "/cases/indoor",
        alt:"",
      },
      {
        title1: "",
        ...
        videoPoster:"",
        videoUrl:"",
        buttonTitle:"menu.outdoorCases",
        buttonPath: "/cases/outdoor",
        alt:"",
      },
